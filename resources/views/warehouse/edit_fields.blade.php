<div class="row">
    <input type="hidden" id="warehouse_edit_Id" value="{{ $warehouse->id }}" name="warehouse_id"/>
    <div class="col-lg-6 col-sm-12 mb-5">
        {{ Form::label('name', __('messages.warehouse.warehouse_name').':', ['class' => 'form-label required mb-3']) }}
        {{ Form::text('name', null, ['class' => 'form-control form-control-solid','required','placeholder' => __('messages.warehouse.warehouse_input_name')]) }}
    </div>
    <div class="col-lg-6 col-sm-12 mb-5">
...
<div class="float-end">
    <div class="form-group col-sm-12">
        <button type="submit" name="save" class="btn btn-primary mx-3" id="editSaveWarehouse" data-status="0"
