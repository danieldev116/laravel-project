...
<body>
    ...
    <div {{ $styleCss }}="border-top: 15px solid {{ $supplier_template_color }};">
        <table class="mt-4" width="100%">
            <tr>
                <td class="header-left">
                    <div class="main-heading">{{ __('messages.supplier.supplier_name') }}</div>
        ...
        <hr {{ $styleCss }}="background: {{ $supplier_template_color }}">
        <table>
            <tr>
                <td>
            ...
            <tr class="invoice-items">
                <td colspan="2">
                    <table class="items-table">
                        <thead {{ $styleCss }}="border-bottom: 2px solid {{ $supplier_template_color }}">
                            <tr class="tu">
                                <th>#</th>
