    ...
    <table width="100%">
        <tr>
            <td class="header-left">
                <div class="main-heading" {{ $styleCss }}="font-size: 40px">{{ __('messages.supplier.supplier_name') }}
                </div>
                <div class="invoice-number font-color-gray">{{ __('messages.supplier.supplier_id') . ':' }}
                    &nbsp;#{{ $supplier->supplier_id }}</div>
                <div class="logo"><img width="100px" src="{{ getLogoUrl($supplier->tenant_id) }}" alt="no-image"></div>
            </td>
        </tr>
    </table>
    <br>
        ...
        <tr class="invoice-items">
            <td colspan="2">
                <table class="d-items-table table-striped table-bordered">
                    <thead>
                        <tr {{ $styleCss }}="background:{{ $supplier_template_color }};">
        ...
        <tr>
            ...
            <td>
                <table class="d-invoice-footer">
                    ...
                    <tr>
                        <td class="font-weight-bold">{{ __('messages.supplier.discount') . ':' }}</td>
                        <td class="text-nowrap">
                    ...
                    <tr>
                        <td class="font-weight-bold">{{ __('messages.supplier.total') . ':' }}</td>
                        <td class="text-nowrap">
