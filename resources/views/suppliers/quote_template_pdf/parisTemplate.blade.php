...
<body>
    ...
    <table width="100%">
        <tr>
            <td colspan="1">
                <div class="main-heading" {{ $styleCss }}="border-bottom: 10px solid {{ $supplier_template_color }}">
                    {{ __('messages.supplier.supplier_name') }}</div>
                <div class="logo"><img width="140px" src="{{ getLogoUrl($supplier->tenant_id) }}" alt=""></div>
            </td>
        </tr>
    </table>
    <br>
        ...
        <thead>
            <tr>
                <td class="vertical-align-top">
                    ...
                    <span>{{ html_entity_decode(getAppName($supplier->tenant_id)) }}</span><br>
                    <b>{{ __('messages.common.address') . ':' }}&nbsp;</b>{{ $setting['company_address'] }}<br>
                    <b>{{ __('messages.user.phone') . ':' }}&nbsp;</b>{{ $setting['company_phone'] }}<br>
                    <strong
                        class="tu">{{ __('messages.supplier.supplier_id') . ':' }}&nbsp;</strong>#{{ $supplier->supplier_id }}<br>
        ...
        <tr class="invoice-items">
            <td colspan="2">
                ...
                ;border-bottom: 2px solid {{ $supplier_template_color }};">
                        <tr class="tu" {{ $styleCss }}="color: {{ $supplier_template_color }};">
                            <th>#</th>
                    ...
                    <tbody style="border-bottom: 2px solid {{ $supplier_template_color }}">
            ...
            <td>
                <table class="invoice-footer">
                    ...
                    <tr>
                        ...
                        <td class="text-nowrap" {{ $styleCss }}="color: {{ $supplier_template_color }}">
