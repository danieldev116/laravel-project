        ...
        <thead>
            <tr>
                <td class="vertical-align-top">
                    ...
                    @endif
                    <strong {{ $styleCss }}="color: {{ $supplier_template_color }}"
                        class="tu">{{ __('messages.supplier.supplier_id') . ':' }}&nbsp;</strong>
                    #{{ $supplier->supplier_id }}<br>
                    <strong {{ $styleCss }}="color:{{ $supplier_template_color }}"
                        class="tu">{{ __('messages.supplier.supplier_date') . ':' }}
                        &nbsp;</strong>{{ \Carbon\Carbon::parse($supplier->supplier_date)->translatedFormat(currentDateFormat()) }}<br>
                    <strong {{ $styleCss }}="color:{{ $supplier_template_color }}"
                        class="tu">{{ __('messages.supplier.due_date') . ':' }}
        ...
        <tr class="invoice-items">
            <td colspan="2">
                ...
                ; border-bottom: 2px solid {{ $supplier_template_color }}">
                    ...
                    <tbody {{ $styleCss }}="border-bottom: 1px solid {{ $supplier_template_color }};">
                ...
                <table class="invoice-footer">
                    ...
                    <tr>
                        <td class="font-weight-bold tu"
                            {{ $styleCss }}="color:{{ $supplier_template_color }}; font-size: 17px">
