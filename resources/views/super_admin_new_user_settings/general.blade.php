        ...
        <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="form-group col-lg-2 col-md-6 mb-5 country-code">
                    ...
                    {{ Form::tel('country_phone', '+1', ['class' => 'form-control width-0', 'onkeyup' => 'if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,"")', 'id' => 'newUserCountryPhone']) }}
                    {{ Form::hidden('country_code', $data['country_code'] ?? '+1', ['id' => 'newUserCountryCode']) }}
                </div>

                <div class="form-group col-lg-4 col-md-6 mb-5">
                    {{ Form::label('company_phone', __('messages.setting.company_phone') . ':', ['class' => 'form-label required mb-3']) }}
                    <br>
                    {{ Form::tel('company_phone', $data['company_phone'] ?$data['company_phone'] :'+1', ['class' => 'form-control form-control-solid', 'id' => 'newUserPhoneNumber', 'onkeyup' => 'if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,"")', 'required']) }}
                    {{ Form::hidden('prefix_code', $data['prefix_code'] ?? '+1', ['id' => 'newUserPrefixCode']) }}
