    ...
    <div class="d-flex flex-column">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                   <div class="row">
                    <div class="col-12"><h4 class="font-weight-bold text-center mb-5">Purchase Details : {{ $purchase->reference_code}}</h4></div>
                   </div>
                   <div class="custom-line-height row">
                    <div class="col-md-4">
                        ...
                        <div class="p-4">
                            <div class="d-flex align-items-center pb-1">
                                <i class="text-primary fa fa-user"></i>&nbsp; {{ $purchase->supplier->name}}
                            </div>
                            <div class="d-flex align-items-center pb-1">
                                <i class="text-primary fa fa-envelope"></i>&nbsp; {{ $purchase->supplier->email}}
                            </div>
                            <div class="d-flex align-items-center pb-1">
                                <i class="text-primary fa fa-mobile-alt"></i>&nbsp; {{ $purchase->supplier->phone}}
                            </div>
                            <div class="d-flex align-items-center">
                                <i class="text-primary fa fa-location-dot"></i>&nbsp; {{ $purchase->supplier->address}}
                            </div>
                        </div>
                    </div>
                    <div class="m-md-0 m-4 col-md-4">
                        ...
                        <div class="p-4">
                            <div class="d-flex align-items-center pb-1">
                                <i class="text-primary fa fa-user"></i>&nbsp; {{ $purchase->company_info['company_name'] ?? '' }}
                            </div>
                            <div class="d-flex align-items-center pb-1">
                                <i class="text-primary fa fa-envelope"></i>&nbsp; {{ $purchase->company_info['company_email'] ?? '' }}
                            </div>
                            <div class="d-flex align-items-center pb-1">
                                <i class="text-primary fa fa-mobile-alt"></i>&nbsp; {{ $purchase->company_info['company_phone'] ?? '' }}
                            </div>
                            <div class="d-flex align-items-center">
                                <i class="text-primary fa fa-location-dot"></i>&nbsp; {{ $purchase->company_info['company_address'] ?? '' }}
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        ...
                        <div class="p-4">
                            <div class="pb-1">
                                <span class="me-2">Reference :</span><span>{{ $purchase->reference_code}}</span>
                            </div>
                            <div class="pb-1">
                                @php 
                                    $class = "success";
                                ...
                                <table class="table border">
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="py-3">
                                                {{ getCurrencySymbol() }} {{ number_format($purchase->tax_amount, 2) }}
                                    ({{ number_format($purchase->tax_rate,2) }}) %
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="py-3">{{ __('messages.purchases.purchase_discount') }}</td>
                                            <td class="py-3">{{ getCurrencySymbol() }} {{ number_format($purchase->discount, 2) }}</td>
                                        </tr>
                                        <tr>
                                            <td class="py-3">{{ __('messages.purchases.purchase_shipping') }}</td>
                                            <td class="py-3">{{ getCurrencySymbol() }} {{ number_format($purchase->shipping,2) }}</td>
                                        </tr>
                                        <tr>
                                            <td class="py-3 text-primary">{{ __('messages.purchases.purchase_grand_total') }}</td>
                                            <td class="py-3 text-primary">{{ getCurrencySymbol() }} {{ number_format($purchase->grand_total,2) }}</td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
