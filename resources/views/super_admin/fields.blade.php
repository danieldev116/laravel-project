<div class="row">
    ...
    <div class="col-lg-6">
        <div class="mb-5">
            ...
            {{ Form::tel('contact', isset($user)?$user->contact:'+1', ['class' => 'form-control form-control-solid', 'onkeyup' => 'if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,"")','id'=>'phoneNumber']) }}
            {{ Form::hidden('region_code',isset($user) ? $user->region_code : '+1',['id'=>'prefix_code']) }}
