                    ...
                    <form id="userProfileEditForm" method="POST"
                        ...
                        <div class="card-body">
                            ...
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-8 fv-row fv-plugins-icon-container">
                                    {{ Form::tel('contact', isset($user)?$user->contact:'+1', ['class' => 'form-control removeFocus', 'placeholder' =>  __('messages.client.contact_no'), 'onkeyup' => 'if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,"")','id'=>'phoneNumber']) }}
