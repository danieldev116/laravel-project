        ...
        <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="form-group col-sm-2 mb-5 user-country-code">
                    ...
                    {{ Form::tel('country_phone', '+1', ['class' => 'form-control width-0', 'onkeyup' => 'if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,"")', 'id' => 'countryPhone']) }}
                    {{ Form::hidden('country_code', !empty($settings['country_code']) ? $settings['country_code'] : $data['country_code'], ['id' => 'countryCode']) }}
                </div>
                <div class="form-group col-sm-4 mb-5">
                    {{ Form::label('company_email', __('messages.setting.company_email') . ':', ['class' => 'form-label required mb-3']) }}
                    {{ Form::text('company_email', !empty($settings['company_email']) ? $settings['company_email'] : ($data['company_email'] ?? ''), ['class' => 'form-control form-control-solid', 'required', 'placeholder' => __('messages.setting.company_email')]) }}
                </div>
                <div class="form-group col-sm-4 mb-5">
