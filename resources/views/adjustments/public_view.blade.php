...
<head>
    ...
    <title>adjustment | {{ getAppName($adjustment->tenant_id) }}</title>
    <!-- Favicon -->
    <link rel="icon" href="{{ asset(getSettingValue('favicon_icon', $adjustment->tenant_id)) }}" type="image/png">
            ...
            <div class="d-flex flex-column flex-lg-row">
                <div class="flex-lg-row-fluid mb-10 mb-lg-0 me-lg-7 me-xl-10">
                    <div class="p-4 p-sm-12">
                        ...
                        @include('adjustments.show_fields',['isPublicView'=> false])
                    </div>
                </div>
            </div>
        </div>
