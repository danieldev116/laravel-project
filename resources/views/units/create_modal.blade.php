    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h2>{{__('messages.units.create_unit')}}</h2>
                <button type="button" class="btn-close" data-bs-dismiss="modal"
                        aria-label="Close"></button>
            </div>
            {{ Form::open(['id'=>'addUnitForm']) }}
            <div class="modal-body scroll-y">
                ...
                <div class="row">
                    <div class="form-group col-sm-12 mb-5">
                        ...
                        {{ Form::text('short_name', null, ['id'=>'short_name','class' => 'form-control form-control-solid','required','placeholder' => __('messages.units.short_name')]) }}
                    </div>
                </div>
                <div class="row">
                    <div class="form-group col-sm-12 mb-5">
