<div class="row">
    ...
    <div class="col-lg-6 col-sm-12 mb-5">
        ...
        {{ Form::select('expense_category_id', $expenses,  ['class' => 'form-select io-select2', 'id' => 'expense_category_id', 'placeholder' => __('messages.expenses.expense_choose_category'), 'required', 'data-control' => 'select2']) }}
    </div>
    <div class="col-lg-6 col-sm-12 mb-5">
        {{ Form::label('amount', __('messages.expenses.expense_amount') . ':', ['class' => 'form-label  mb-3']) }}
        <div class="input-group">
            {{ Form::text('amount', 0.00, ['class' => 'form-control form-control-solid', 'placeholder' => __('messages.expenses.expense_amount'), 'id' => 'amount', 'onkeypress' => "return event.charCode == 46 || (event.charCode >= 48 && event.charCode <= 57)"]) }}
            <span class="input-group-text">$</span>
        </div>
    </div>
    <div class="col-lg-6 col-sm-12 mb-5">
        {{ Form::label('Notes', __('messages.expenses.expense_details') . ':', ['class' => 'form-label mb-3']) }}
...
<div class="float-end">
    <div class="form-group col-sm-12">
        <button type="submit" name="draft" class="btn btn-primary mx-3" id="saveAsDraftexpense" data-status="0"
