...
<body>
    ...
    <div class="">
        {{-- <div class="" style="font-size: 25px">{{ __('messages.common.invoice') }}</div> --}}
    ...
    <div class="card-body">
        <table class="table table-bordered w-100">
            <thead>
                <tr>
                    <th class="py-1" style="width:33.33% !important;">{{ __('messages.common.from') }}</th>
                    <th class="py-1" style="width:33.33% !important;">{{ __('messages.common.to') }}</th>
                    <th class="py-1" style="width:33.33% !important;">{{ __('messages.common.invoice') }}</th>
                </tr>
            </thead>
            <tbody>
                <tr>
        ...
        <div class="table-responsive-sm">
            <table class="table table-striped">
                <thead>
                    <tr>
                        <th class="py-1">#</th>
                        <th class="py-1">{{ __('messages.product.product') }}</th>
                        <th class="py-1"> {{ __('messages.invoice.qty') }}</th>
                        <th class="py-1">{{ __('messages.product.unit_price') }}</th>
                        <th class="py-1">{{ __('messages.invoice.tax') . '(in %)' }}</th>
                        <th class="py-1">{{ __('messages.invoice.amount') }}</th>
                    </tr>
                </thead>
                <tbody>
                    @if (isset($invoice) && !empty($invoice))
                        @foreach ($invoice->invoiceItems as $key => $invoiceItems)
                            <tr class="">
                                ...
                                <td class="text-start">{{ number_format($invoiceItems->quantity, 2) }}</td>
                ...
                <td class="w-25 text-end">
                    <table class="">
                        <tbody class="text-end">
                            ...
                            <tr>
                                <td class="font-weight-bold text-nowrap pr-3">
